...
# datasets related
from lib.train.dataset import Lasot, Got10k, MSCOCOSeq, ImagenetVID, TrackingNet, Imagenet1k, VastTrack, BDD100K_Night, SHIFT_Night, ExDark
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["LASOT", "GOT10K_vottrain", "GOT10K_votval", "GOT10K_train_full",
                        ...
                        "REFCOCOG", "TNL2K_train", "OTB99_train","VASTTRACK", "BDD100K_NIGHT", "SHIFT_NIGHT", "ExDark"]
        if name == "LASOT":
