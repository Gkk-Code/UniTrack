...
from lib.models.UniTrack.fastitpn import GlobalPromptMemory
class UniTrack_Actor(BaseActor):
    """ Actor for training the UniTrack"""
    ...
    def compute_losses(self, pred_dict, gt_dict, return_status=True):
        ...
        # weighted sum
        loss1 = GlobalPromptMemory.loss1
