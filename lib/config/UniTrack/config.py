...
cfg.MODEL.TASK_INDEX.BDD100K_NIGHT = 0 #####################
cfg.MODEL.TASK_INDEX.ExDark = 0###########################
cfg.MODEL.TASK_INDEX.SHIFT_NIGHT = 0 ###########################################3
...
cfg.DATA.USE_NLP.BDD100K_NIGHT = False###############################################
cfg.DATA.USE_NLP.SHIFT_NIGHT = False#####################################################3
cfg.DATA.USE_NLP.ExDark  = False#######################################################
